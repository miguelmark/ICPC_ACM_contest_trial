 ...
 * @author Miguel
 */
public class Team_UVI_Player implements black.Player {
    ...
    private class BoardSpace {
        ...
        public void setSecondPiece() {
            this.secondPiece = Team_UVI_Player.findNextPossibleMove(this.firstPiece);
        }
    ...
    public Team_UVI_Player(int[][] gameboard) {
